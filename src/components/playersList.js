...
function PlayersList() {
  ...
  const columns = [
    ...
    // },
    {
      ...
      dataIndex: '',
      key: 'x',
      render: () => <a onClick={showModal} className='playersList'>View</a>,
    },
  ];
  const data = [
    {
      ...
      >
        ...
        <div className="userHeader">
          <div className='row d-flex'>
            <div className='col-md-3' style={{alignItems:"center",textAlign: 'center'}}>
              <img className="avatar" src={userImg}></img>
              <h6 className="userName">Gukesh Dommaraju</h6>
              {/* <span className="usermail">gukeshgm@2024.com</span> */}
            </div>
          ...
          <div className="userDetails row col-md-12 d-flex">
            ...
            <Input disabled="true" className="col-md-6 userData" value={'Gukesh'} />
            </div>
            <div className='col-md-6 row d-flex'>
            <p className="col-md-6 userData">Email</p>
            <Input disabled="true" className="col-md-6 userData" value={'gukeshgm@2024.com'} />
            </div>
            ...
            <Input disabled="true" className="col-md-6 userData" value={'Tamil'} />
            </div>

            <div className='col-md-6 row d-flex'>
            <p className="col-md-6 userData">Son/Daughter of</p>
            <Input disabled="true" className="col-md-6 userData" value={'Dommaraju'} />
            </div>
            <div className='col-md-6 row d-flex'>
            <p className="col-md-6 userData">Relationship</p>
            <Input disabled="true" className="col-md-6 userData" value={'Father'} />
            </div>
            <div className='col-md-6 row d-flex'>
            <p className="col-md-6 userData">Date of Birth</p>
            <Input disabled="true" className="col-md-6 userData" value={'15 July 2005'} />
            </div>
            <div className='col-md-6 row d-flex'>
            <p className="col-md-6 userData">Gender</p>
            <Input disabled="true" className="col-md-6 userData" value={'Male'} />
            </div>
            <div className='col-md-6 row d-flex'>
            <p className="col-md-6 userData">Address</p>
            <Input disabled="true" className="col-md-6 userData" value={'***********'} />
            </div>
            <div className='col-md-6 row d-flex'>
            <p className="col-md-6 userData">Location</p>
            <Input disabled="true" className="col-md-6 userData" value={'Sivaganagai'} />
            </div>
